...
class LSTMModel(nn.Module):
    def __init__(self, cnn_length, cnn_embedding_length, ohclv_length, lstm_hidden_dim, output_dim, num_lstm_layers):
        ...
        self.lstm = nn.LSTM(input_size=ohclv_length, hidden_size=lstm_hidden_dim, num_layers=num_lstm_layers, batch_first=True)
    ...
    def forward(self, x, ohclv):
        ...
        lstm_out, _ = self.lstm(ohclv)  # (batch_size, lstm_length, lstm_hidden_dim)
        lstm_out = lstm_out[:, -1, :]
